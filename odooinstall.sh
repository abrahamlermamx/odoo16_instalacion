...
#Creamos en directorio en donde se almacenar� el archivo de configuraci�n y log de odoo:
sudo mkdir /etc/odoo && sudo mkdir /var/log/odoo/
# Instalamos Postgres y librer�as base del sistema:
...
#Agregamos los siguientes par�metros al archivo de configuraci�n de odoo:
